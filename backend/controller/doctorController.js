const logic = require('../logic/doctorLogic'); // Asegúrate de que la ruta sea correcta
const { doctorSchemaValidation } = require('../validations/doctorValidations'); // Suponiendo que tienes un esquema de validación
